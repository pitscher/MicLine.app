...
- **Spec-driven & tested:** new behavior needs a spec under `specs/` before code, and ships with tests covering it in the same PR — untested feature code does not merge. Bugfixes need a failing test first.
